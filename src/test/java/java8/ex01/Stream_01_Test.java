...
public class Stream_01_Test {
    ...
    public void test_stream_filter_and_match() throws Exception {
        ...
        List<Order> result = orders.stream().filter(o->"Johnny".equals(o.getCustomer().getFirstname())
    ...
    public void test_stream_findFirst() throws Exception {
        ...
        Optional<Order> result = orders.stream().filter(o->"Sophie".equals(o.getCustomer())).findFirst();
